    ...
    public partial class initLoad : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertiesType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookingAppointments_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BookingAppointments_Properties_PropertyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);  // Changed the delete behavior to NoAction to prevent cascading deletes.
                });

            // Creating foreign key constraint after table creation
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingAppointments_ApplicationUserId",
                table: "BookingAppointments",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingAppointments_PropertyId",
                table: "BookingAppointments",
                column: "PropertyId");
