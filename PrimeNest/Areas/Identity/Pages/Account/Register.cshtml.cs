...
namespace PrimeNest.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (files.Count > 0)
                {
                    ...
                    var uploadsFolder = Path.Combine(webRootPath, "images", "User");
                ...
                var user = new ApplicationUser()
                {
                    ...
                    Role = Input.Role,
                    ProfilePic = files.Count > 0 ? "/images/User/" + fileName : "/images/default-profile.png" // Default Image
                };
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.Role_Agent))
                    {
